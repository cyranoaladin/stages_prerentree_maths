...
## Mathématiques — Entrée en Quatrième

### 5 séances de 2 heures — Nexus Réussite — Rentrée 2026-2027
...
2. **Somme des angles**
   ...
   * conception repérée : réponse $180^\circ$ donnée comme angle manquant ;
...
# 6. Progression détaillée des cinq séances
...
> Pour additionner ou soustraire des fractions, on commence par les écrire avec un dénominateur commun. On transforme toute la fraction, pas seulement le dénominateur.
...
|   25-45 min | Conflit cognitif                       | Rectangle $8 \times 5$ : 26 ou 40 ? Que mesure chaque résultat ? | Fares travaille le sens ; Sinda produit une explication formalisée                                                           | Rectangle quadrillé, ficelle        | Périmètre et aire correctement nommés |
...
|       Temps | Phase                      | Tronc commun                                                       | Différenciation                                                         | Supports               | Indicateurs                         |
| ----------: | -------------------------- | ------------------------------------------------------------------ | ----------------------------------------------------------------------- | ---------------------- | ----------------------------------- |
|    0-10 min | Rituel                     | Une équation, une aire, une fraction                               | Individuel                                                              | Mini-tableaux          | 2 ou 3 réussites                    |
|   10-25 min | Angles d’un triangle       | Reconstituer un triangle découpé pour montrer $180^\circ$          | Manipulation                                                            | Triangle en papier     | L’invariant est compris             |
...
|  85-100 min | Ouverture Quatrième    | Produit de relatifs, équation, médiane, événement contraire                   | Ateliers courts                                                 | Quatre cartes découverte | Compréhension initiale               |
...
# 7. Différenciation réaliste et non chronophage

## 7.1 Principe général

La différenciation ne repose pas sur trois cours différents, mais sur :

* un même objectif ;
* un même support de base ;
* des variables didactiques ;
* des aides graduées ;
* un nombre d’exercices adapté ;
* des niveaux de justification différents.

## 7.2 Organisation des fiches

Chaque fiche comporte trois zones.
...
* aide disponible ;
* vérification immédiate après deux exercices.

### Parcours 2 — Maîtrise

* nombres moins immédiats ;
* absence d’étapes ;
...
* tâche ouverte ;
* production d’un contre-exemple ;
* démonstration ;
* généralisation ;
* anticipation d’une notion de Quatrième.

Les parcours ne sont pas attachés définitivement à un élève.

## 7.3 Aides différenciées

### Carte A — Comprendre la consigne

Reformulation et exemple analogue.

### Carte B — Choisir la propriété

Liste de deux ou trois propriétés possibles.
...
Méthode de contrôle sans donner la réponse.

## 7.4 Variables didactiques réutilisables

| Domaine      | Variables                                                         |
| ------------ | ----------------------------------------------------------------- |
| Relatifs     | nombre de termes, présence de parenthèses, position sur la droite |
| Fractions    | dénominateurs égaux, multiples ou premiers entre eux              |
| Aires        | figure simple ou composée, donnée directe ou manquante            |
| Littéral     | coefficients positifs puis relatifs, une ou deux distributivités  |
| Équations    | inconnue d’un côté puis des deux côtés                            |
| Géométrie    | figure fournie, figure à construire, propriété à choisir          |
| Statistiques | données brutes, tableau ou graphique                              |

## 7.5 Groupes de besoin tournants

Avec deux élèves :

* 12 à 15 minutes avec l’enseignant pour le besoin prioritaire ;
* 12 à 15 minutes en autonomie contrôlée ;
* rotation.

Avec trois à cinq élèves :

* groupe A : reconstruction ;
* groupe B : entraînement ;
* groupe C : transfert ;
* rotation toutes les quinze minutes.

## 7.6 Rituel réutilisable

Chaque séance commence par quatre questions :

1. une notion de la séance précédente ;
2. une notion plus ancienne ;
3. une notion solide à entretenir ;
...
Certitude : 1 / 2 / 3 / 4
Justification en une phrase : __________________
```

---

# 8. Plans d’action individualisés

## 8.1 Sinda Chikhaoui

| Élément                       | Plan                                                                                                                                                          |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Objectif prioritaire 1**    | Corriger la gestion des signes, notamment la soustraction d’un négatif                                                                                        |
| **Objectif prioritaire 2**    | Représenter et calculer des fractions équivalentes                                                                                                            |
| **Objectif prioritaire 3**    | Installer distributivité et réduction                                                                                                                         |
| **Objectif prioritaire 4**    | Stabiliser l’aire du triangle                                                                                                                                 |
| **Points d’appui**            | Géométrie, proportionnalité, statistiques                                                                                                                     |
| **Remédiations**              | Droite graduée ; jetons signés ; bandes fractionnaires ; modèle d’aire pour la distributivité ; découpage de triangles                                        |
| **Indicateurs**               | 8/10 sur relatifs et fractions ; 3 développements corrects consécutifs ; unité d’aire correcte ; aucune fausse réponse à confiance 4 sur les notions reprises |
| **Approfondissement**         | Justification géométrique, figures composées, équations simples                                                                                               |
| **Conseil pour la Quatrième** | Ne pas apprendre une règle uniquement sous forme verbale : l’associer à un schéma et à un exemple de contrôle                                                 |

### Plan de travail après le stage

* semaine 1 : relatifs, 10 minutes trois fois ;
* semaine 2 : fractions ;
* semaine 3 : calcul littéral ;
* semaine 4 : aires et problème mixte.

## 8.2 Fares Darghouth

| Élément                       | Plan                                                                                                                                                                |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Objectif prioritaire 1**    | Distinguer aire, périmètre et unités                                                                                                                                |
| **Objectif prioritaire 2**    | Reconstruire les propriétés élémentaires des triangles                                                                                                              |
| **Objectif prioritaire 3**    | Stabiliser symétrie centrale et parallélogramme                                                                                                                     |
| **Objectif prioritaire 4**    | Corriger la soustraction de fractions                                                                                                                               |
| **Objectif à diagnostiquer**  | Calcul littéral                                                                                                                                                     |
| **Point à consolider**        | Confiance sur les relatifs et la moyenne                                                                                                                            |
| **Points d’appui**            | Proportionnalité, statistiques, calcul de relatifs                                                                                                                  |
| **Remédiations**              | Manipulation de surfaces ; codage des figures ; gabarit données-propriété-conclusion ; bandes fractionnaires ; diagnostic littéral                                  |
| **Indicateurs**               | 4 exercices consécutifs aire/périmètre réussis ; 3 angles calculés correctement ; identification du parallélogramme ; au moins 70 % sur le parcours littéral adapté |
| **Conseil pour la Quatrième** | Avant de calculer, écrire ce que représente le résultat attendu et son unité                                                                                        |

### Plan de travail après le stage

* semaine 1 : aire/périmètre ;
...
## 9.1 Évaluation diagnostique

### Sources

* test initial de 18 questions ;
* niveau de certitude ;
* détail des erreurs ;
* mini-diagnostic complémentaire en séance 1 ;
* observation orale des procédures.
...
* degré de confiance ;
* réaction à un contre-exemple.

## 9.2 Évaluation formative

À chaque séance :

* quatre questions rituelles ;
* observation des ateliers ;
* un problème de transfert ;
* un exit ticket ;
* auto-évaluation.

## 9.3 Grille de maîtrise

|                   Niveau | Description                                                     |
| -----------------------: | --------------------------------------------------------------- |
|        **0 — Non situé** | L’élève n’a pas répondu ou les données sont insuffisantes       |
|   **1 — À reconstruire** | Réussite rare, procédure instable ou conception erronée         |
| **2 — En consolidation** | Réussite dans les cas simples avec aide ou hésitation           |
|         **3 — Maîtrisé** | Réussite autonome et expliquée                                  |
|        **4 — Transféré** | Mobilisation dans un problème nouveau ou justification générale |

## 9.4 Critères de réussite finale

### Seuil minimal

* 70 % des items du tronc commun réussis ;
* aucune erreur à forte certitude sur les conceptions prioritaires ;
* capacité à corriger et expliquer au moins une ancienne erreur.

### Objectif attendu

* 80 % des items prioritaires réussis ;
* deux réussites consécutives sur chaque notion reprise ;
* unité correcte dans tous les calculs de grandeur ;
* justification géométrique structurée.

### Approfondissement

* 90 % ou plus ;
* transfert dans un problème inédit ;
* explication d’une méthode à l’oral ;
* réussite d’une anticipation de Quatrième.

## 9.5 Portfolio de stage

Chaque élève conserve :

1. son bilan initial ;
2. la fiche de diagnostic complémentaire ;
3. les cinq fiches de séance ;
4. les cinq exit tickets ;
5. deux travaux corrigés choisis ;
6. l’évaluation finale ;
7. sa grille d’auto-évaluation ;
8. son plan de travail de rentrée.

---

# 10. Banque de supports et d’activités

## 10.1 Supports à préparer

| Code  | Support                             |
| ----- | ----------------------------------- |
| D0    | Mini-diagnostic complémentaire      |
| R1    | Grande droite graduée               |
| R2    | Jetons positifs et négatifs         |
| F1    | Bandes fractionnaires               |
| F2    | Cartes « fraction équivalente »     |
| G1    | Cartes aire/périmètre/unité         |
| G2    | Rectangles et triangles à découper  |
| L1    | Jetons algébriques ou modèle d’aire |
| L2    | Balance d’équation                  |
| GE1   | Triangles découpés                  |
| GE2   | Papier calque et cartes symétrie    |
| M1    | Mini-tableaux effaçables            |
| E1    | Cartes-aides A à D                  |
| S1-S5 | Fiches différenciées                |
| B1    | Grille de suivi                     |
| B2    | Carte d’engagement                  |

## 10.2 Activités concrètes
...
* « les deux angles connus mesurent $50^\circ$ et $70^\circ$ » ;
* « la somme des angles d’un triangle vaut $180^\circ$ » ;
* « le troisième angle mesure $60^\circ$ ».

L’élève remet les cartes dans l’ordre et ajoute les connecteurs.

---

# 11. Annexes — modèles prêts à l’emploi

## Annexe A — Fiche type de séance

### Séance n° ___ — Thème : __________________
...
## Annexe B — Modèle de fiche différenciée

### Tronc commun

1. Exercice d’activation.
2. Exemple à expliquer.
3. Erreur à corriger.

### Parcours Consolidation

* [ ] Je représente la situation.
* [ ] J’utilise la carte-aide si nécessaire.
...
# 12. Annexe E — Exercices différenciés et corrections
...
11. Expliquer pourquoi (a-(-b)=a+b).
12. Anticipation : calculer $(-3)\times4$ et $(-3)\times(-4)$, puis proposer une règle.
...
1. Rectangle $8\text{ cm}\times5\text{ cm}$ :
...
4. Un triangle a une aire de 21 cm² et une base de 7 cm. Calculer sa hauteur.
5. Convertir $0,05\text{ m}^2$ en cm².
6. Un rectangle mesure 10 cm sur 6 cm. On retire un rectangle de 4 cm sur 2 cm. Calculer l’aire restante.

### Approfondissement

7. Trouver deux rectangles de périmètre 20 cm ayant des aires différentes.
...
2. $12\text{ cm}^2$
3. m ou cm ; cm² ; m ou km
4. $7\times h/2=21$, donc $h=6\text{ cm}$
5. $500\text{ cm}^2$
6. $60-8=52\text{ cm}^2$
7. $1\times9$ : aire 9 ; $2\times8$ : aire 16
8. Par (9)
...
7. Un rectangle a pour longueur (x+2) et largeur (x). Exprimer son périmètre.
...
1. Deux angles d’un triangle mesurent $50^\circ$ et $70^\circ$. Calculer le troisième.
2. Un triangle rectangle possède un angle aigu de $35^\circ$. Calculer l’autre.
3. Quelle figure générale est un quadrilatère ayant un centre de symétrie ?
4. Que conserve une symétrie centrale ?

### Maîtrise

5. Un triangle a deux angles égaux à $48^\circ$. Calculer le troisième.
...
8. Un triangle a pour côtés 3 cm, 4 cm et 5 cm. Vérifier que $3^2+4^2=5^2$. Quelle conjecture peut-on formuler ?
...
# 15. Recommandations didactiques finales

## 15.1 Ne pas commencer par redonner les règles

Pour une réponse fausse donnée avec certitude, la règle énoncée directement est souvent inefficace. Il faut :

1. faire prédire ;
2. confronter à une représentation ou un contre-exemple ;
3. faire verbaliser la contradiction ;
4. reconstruire ;
5. entraîner.

## 15.2 Distinguer erreur et absence de réponse

L’absence de réponse de Fares en calcul littéral ne doit pas être traitée comme une preuve d’incompétence. Elle appelle un diagnostic bref et neutre.

## 15.3 Exiger la grandeur avant le calcul

Avant tout exercice de mesure :

> « Que cherche-t-on ? Une longueur, une surface, un volume ou une durée ? »

Puis :

> « Quelle unité doit apparaître ? »

## 15.4 Faire verbaliser les procédures

Questions efficaces :

* « Quelle règle as-tu utilisée ? »
* « Qu’est-ce qui te permet de choisir cette opération ? »
* « Comment peux-tu vérifier ? »
* « Quelle réponse serait impossible ? »
* « Qu’est-ce qui t’a rendu certain ? »

## 15.5 Alterner blocage et entrelacement

* Au début : plusieurs exercices d’une même structure pour stabiliser.
* Ensuite : exercices mélangés pour obliger à reconnaître la méthode pertinente.
* Enfin : problème intégré.

## 15.6 Utiliser la confiance comme donnée pédagogique

Une réponse correcte avec confiance 1 ou 2 appelle une consolidation.

Une réponse fausse avec confiance 3 ou 4 appelle une confrontation prioritaire.

L’objectif n’est pas de rendre les élèves moins confiants, mais de rendre leur confiance plus fiable.

---

# 16. Recommandations pour la poursuite en Quatrième

Après le stage, il est recommandé de maintenir :

* trois séances de dix minutes par semaine ;
* quatre automatismes et un problème court ;
* une correction écrite des erreurs ;
* une indication du degré de confiance ;
* un retour mensuel sur les compétences fragiles.

Un point de contrôle est conseillé trois à quatre semaines après la rentrée sur :

* relatifs ;
* fractions ;
* calcul littéral ;
* aires et unités ;
* angles et propriétés ;
* premières équations.

---

## Synthèse de la programmation retenue
...
* imposer à tout le groupe le parcours d’un seul élève ;
* fabriquer un cours différent pour chaque élève.

Elle conserve un tronc commun robuste tout en affectant à chacun des tâches, des aides et des critères de réussite adaptés.

[1]: https://www.education.gouv.fr/bo/2026/Hebdo10/MENE2602912A?utm_source=chatgpt.com "Programmes d’enseignement de français et de mathématiques du cycle des approfondissements (cycle 4) | Ministère de l'Education nationale"
[2]: https://eduscol.education.gouv.fr/4362/enseigner-au-cycle-4?utm_source=chatgpt.com "Enseigner au cycle 4 | éduscol | Ministère de l'Éducation nationale | Direction générale de l'enseignement scolaire"
[3]: https://eduscol.education.gouv.fr/5736/ressources-d-accompagnement-du-programme-de-mathematiques-au-cycle-4 "Ressources d'accompagnement du programme de mathématiques au cycle 4 | éduscol | Ministère de l'Éducation nationale | Direction générale de l'enseignement scolaire"
