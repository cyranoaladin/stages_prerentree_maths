...
|---:|---|---|---|
| 10 min | Ouverture | Contrôle sur la séance 3 : signe de −3x² + 12 | Répond, déclare sa certitude |
...
Prendre f(x) = x³ − 3x². Calculer f'(x) = 3x² − 6x, puis **f''(x) = 6x − 6**.
...
| (uv)' écrit u'v' | Test numérique sur u = v = x en x = 2 : (x²)' = 2x = 4, contre 1 × 1 = 1 |
