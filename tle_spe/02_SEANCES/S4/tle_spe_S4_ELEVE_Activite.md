# Terminale Spécialité Mathématiques — Séance 4 — Fiche élève
## Dérivation : du nombre dérivé aux variations

**Ton objectif de séance :** ne plus confondre le signe de f' et le signe de f, et savoir
passer du tableau de signes de f' aux variations de f.

### Règle de travail

- J'écris u, v, u' et v' **séparément** avant d'appliquer une formule.
- Je factorise f' avant de conclure sur les variations.
...
Étudier le signe de −3x² + 12 sur ℝ.
...
**Exercice 1.** Soit f(x) = (3x − 2)(x² + 1). Calculer f'(x).
...
**Exercice 2.** Soit f(x) = (2x − 1)/(x + 3), définie sur ]−3 ; +∞[. Calculer f'(x) et donner
son signe.
...
**Exercice 3.** Soit f(x) = x³ − 12x. Déterminer l'intervalle sur lequel f est décroissante.
...
**Exercice 5.** Soit f(x) = x³. Déterminer l'équation de la tangente à la courbe de f au
...
**Exercice 6.** Une fonction h vérifie h(3) = −2 et h'(3) = 5. Que représente le nombre 5 ?
Donner l'équation de la tangente à la courbe de h au point d'abscisse 3.
...
**Exercice 7.** Soit f définie sur ℝ par f(x) = (x² + 1)/(x² + 2). Calculer f'(x), étudier
...
**Exercice 8.** Soit f(x) = x³ − 3x². Calculer f'(x) puis f''(x). Dresser le tableau de
...
>
> Le signe de f'' donne les variations de f'. Là où f'' ≥ 0, f' croît : la courbe de f
> tourne vers le haut, on dit que f est **convexe**. Là où f'' ≤ 0, f est **concave**. Le
...
**La différence entre le signe de f' et le signe de f, avec mes mots :** ...................

....................................................................................................

**Ma certitude sur la dérivation, aujourd'hui :** ☐1 ☐2 ☐3 ☐4
