# Terminale Spécialité Mathématiques — Cahier des cinq séances — Alexandre Zahouani
...
|---:|---|---|:---:|
| 1 | Suites numériques : du sens de variation à la récurrence | Rectifier une certitude erronée sur la fonction exponentielle. | Confronter |
...
| 3 | Second degré : discriminant, signe du trinôme, tableau de signes | Reconstruire une notion tenue pour acquise en dérivation. | Confronter |
| 4 | Dérivation : du nombre dérivé aux variations, ouverture sur la convexité | Rectifier une certitude erronée sur les suites numériques. | Confronter |
| 5 | Produit scalaire vers l'espace, probabilités, Python, évaluation | Installer les repères indispensables sur le produit scalaire. | Installer |
...
Rectifier une certitude erronée sur la fonction exponentielle.

L'entraînement collectif porte sur suites numériques ; ton exercice personnel, plus bas, porte sur fonction exponentielle. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Soustrait les exposants sans changer le signe du terme constant : écrit $2x - x - 1$ en oubliant la parenthèse.
...
Reconstruire une notion tenue pour acquise en dérivation.

L'entraînement collectif porte sur second degré ; ton exercice personnel, plus bas, porte sur dérivation. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Inverse le lien entre le signe de f' et le sens de variation, sur l'autre branche.
...
> **Piège.** Interprète une borne d'intervalle comme un extremum sans étudier le changement de signe.
...
> **Piège.** Erreur de signe dans le développement de $f'(a)(x - a) + f(a)$.

> **Méthode.** Une seule formule : $y = f'(a)(x - a) + f(a)$. Calculer $f(a)$ et $f'(a)$ séparément avant de substituer.

**4. Dérivation — Dériver un quotient.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réussi avec une certitude de 1/4.
...
**Ton point personnel pendant le temps différencié :** Suites numériques.  
**Ta piste :** Confronter. Écris d'abord ce que tu croyais, puis ce qui l'a mis en défaut. C'est cette trace-là qui empêche l'erreur de revenir.
...
L'entraînement collectif porte sur dérivation ; ton exercice personnel, plus bas, porte sur suites numériques. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
**2. Suites numériques — Déterminer le sens de variation d'une suite géométrique par sa raison.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réussi avec une certitude de 2/4.
...
> **Piège.** Erreur de signe dans la somme $6 + ( - 4)$.
