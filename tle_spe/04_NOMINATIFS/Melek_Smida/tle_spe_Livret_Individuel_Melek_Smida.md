# Terminale Spécialité Mathématiques — Livret individuel — Melek Smida
...
|---|---|---|
| Certitude à revoir | Suites numériques | **CONFRONTER** |
| Sans réponse | Second degré | **DIAGNOSTIQUER** |
| Difficulté repérée, sans fausse certitude | _aucun_ | **INSTALLER** |
| Réussite hésitante | _aucun_ | **CONSOLIDER** |
| Acquis disponible | Dérivation · Fonction exponentielle · Produit scalaire | **ENTRETENIR** |
...
### Second degré — 66,7 % · Sans réponse · **DIAGNOSTIQUER**
...
### Dérivation — 100 % · Acquis disponible · **ENTRETENIR**
...
|---:|---|---|---|
| 1 | Suites numériques | **CONFRONTER** | Une réponse fausse a été donnée avec assurance. On part d'un cas qui met la conviction en défaut, on fait verbaliser le raisonnement, puis on reconstruit la notion avant tout entraînement. |
| 2 | Second degré | **DIAGNOSTIQUER** | Aucune réponse n'a été apportée sur ce domaine. On ne devine pas : un test ciblé est passé au démarrage, et la remédiation est décidée à partir de ce qu'il montre. |

### Tes points d'appui

- Dérivation — réponses justes, données avec assurance : c'est un vrai point d'appui pour la suite.
- Tu peux t'appuyer sur la fonction exponentielle : les réponses sont justes et assumées, rien à reprendre pour l'instant.
- Produit scalaire — acquis et disponible. On s'en servira comme socle pour aller plus loin.
...
| 2 | Fonction exponentielle : exposants, équations, vers le logarithme | Second degré (DIAGNOSTIQUER) | Diagnostiquer | | |
| 3 | Second degré : discriminant, signe du trinôme, tableau de signes | Consolidation d'ensemble | Entretenir | | |
...
- **Séance 2** — Établir le niveau réel sur le second degré avant de choisir une remédiation.
...
Ton positionnement comporte **2 item(s)** à reprendre. Pour chacun : l'énoncé exact, ta réponse, la réponse attendue, l'origine de l'erreur, ce qu'il faut retenir, et le geste correct à installer.
...
|---:|---|---|
| 1 | Suites numériques — confronter | |
| 2 | Second degré — diagnostiquer | |
| 3 | | |
| 4 | | |
...
|---|---|---|---|
| Second degré | Sans réponse | | |
| Dérivation | Acquis disponible | | |
| Fonction exponentielle | Acquis disponible | | |
...
---
_Source pédagogique unique : `stage_prerentree_terminale_maths.md`. Diagnostic issu du bilan de positionnement du 2026-08-19 ; aucun contenu n'est extrapolé au-delà._
