# Terminale Spécialité Mathématiques — Cahier des cinq séances — Yassine Ben Hassine
...
| 3 | Second degré : discriminant, signe du trinôme, tableau de signes | Reconstruire une notion tenue pour acquise sur la fonction exponentielle. | Confronter |
| 4 | Dérivation : du nombre dérivé aux variations, ouverture sur la convexité | Rectifier une certitude erronée sur le produit scalaire. | Confronter |
| 5 | Produit scalaire vers l'espace, probabilités, Python, évaluation | Faire apparaître, puis lever, l'idée fausse installée en dérivation. | Confronter |
...
> **Remarque.** Ce que ton positionnement a montré sur ce point : Suites numériques (CONFRONTER). Sur ce domaine, tu as réussi 43 % des questions du positionnement. C'est de là que part ta séance.

> **Rappel.** Un point sur lequel tu peux t'appuyer aujourd'hui : Le bilan ne fait pas encore apparaître de point stabilisé — c'est une photographie de départ, pas un verdict. L'avoir passé sérieusement est déjà un appui : on sait exactement par où commencer.
...
> **Piège.** Confond une raison strictement comprise entre 0 et 1 avec une raison égale à 1.
...
> **Piège.** Confond une addition et une multiplication dans la relation de récurrence.
...
**1. Second degré — Discuter le nombre de racines réelles selon le signe du discriminant.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réponse fausse au positionnement.

Combien de solutions réelles l'équation $3x^2 - 6x + 4 = 0$ admet-elle ? Justifier.
...
> **Piège.** Applique le cas $\Delta = 0$ sans avoir calculé le discriminant.

> **Méthode.** Le signe de $\Delta$ décide seul : $\Delta > 0$ deux racines, $\Delta = 0$ une racine double, $\Delta < 0$ aucune racine réelle. Ne jamais conclure sans avoir calculé $\Delta$.

**2. Second degré — Résoudre une inéquation du second degré par le signe du trinôme.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réponse fausse au positionnement.
...
> **Piège.** Inverse la règle : place le signe de a entre les racines au lieu de l'extérieur.
...
Reconstruire une notion tenue pour acquise sur la fonction exponentielle.

L'entraînement collectif porte sur second degré ; ton exercice personnel, plus bas, porte sur fonction exponentielle. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.

> **Remarque.** Ce que ton positionnement a montré sur ce point : Fonction exponentielle (CONFRONTER). Sur ce domaine, tu as réussi 50 % des questions du positionnement. C'est de là que part ta séance.
...
> **Piège.** Associe l'équation à la valeur remarquable $e^1 = e$ sans traiter la question posée.
...
Rectifier une certitude erronée sur le produit scalaire.

L'entraînement collectif porte sur dérivation ; ton exercice personnel, plus bas, porte sur produit scalaire. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.

> **Remarque.** Ce que ton positionnement a montré sur ce point : Produit scalaire (CONFRONTER). Sur ce domaine, tu as réussi 50 % des questions du positionnement. C'est de là que part ta séance.
...
**Question 0.** On sait que f' est strictement négative sur l'intervalle ]1 ; 4[. Que
peut-on affirmer ?

Ma réponse : ..................................................  Ma certitude : $\square$1 $\square$2 $\square$3 $\square$4

Examine maintenant ces deux fonctions :
...
**Produit scalaire — Utiliser le critère d'orthogonalité.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réponse fausse au positionnement.
...
Faire apparaître, puis lever, l'idée fausse installée en dérivation.
...
> **Remarque.** Ce que ton positionnement a montré sur ce point : Dérivation (CONFRONTER). Sur ce domaine, tu as réussi 64 % des questions du positionnement. C'est de là que part ta séance.
...
> **Rappel.** Tu as travaillé **Fonction exponentielle** en séance 3. Avant de commencer, écris en une phrase la règle que tu en as retenue — sans regarder tes notes. Si elle ne vient pas, c'est le moment de le dire.
...
**1. Dérivation — Dériver un quotient.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réponse fausse au positionnement.
...
> **Piège.** Erreur de signe : calcule uv' $-$ u'v au lieu de u'$v -$ uv' au numérateur.

> **Méthode.** Appliquer (u/v)' = (u'$v -$ uv')$/v^2$. L'ordre du numérateur n'est pas commutatif : u'v vient en premier.

**2. Dérivation — Interpréter le nombre dérivé.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réponse fausse au positionnement.
...
> **Piège.** Confond le nombre dérivé avec un taux de variation sur un intervalle non réduit à un point.
