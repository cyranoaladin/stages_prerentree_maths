...
|---:|---|---|---|---|---|
| 1 | Suites numériques : du sens de variation à la récurrence | Consolidation d'ensemble | Approfondissement | | |
...
- **Séance 1** — Réinvestir ce qui a été repris, automatiser, mesurer le chemin parcouru. Le contenu précis est ajusté avec le groupe.
