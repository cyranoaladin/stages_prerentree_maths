# Terminale Spécialité Mathématiques — Livret individuel — Sara Bsiri
...
| Acquis disponible | Second degré · Dérivation · Fonction exponentielle · Suites numériques · Produit scalaire | **ENTRETENIR** |
...
Ton bilan ne fait apparaître aucune priorité : tous les domaines évalués sont acquis et assumés. Le stage servira à **prolonger** ces acquis. Choisis dès la première séance un domaine que tu veux pousser plus loin : le parcours d'approfondissement partira de là.

### Tes points d'appui

- Second degré — réponses justes, données avec assurance : c'est un vrai point d'appui pour la suite.
- Tu peux t'appuyer sur la dérivation : les réponses sont justes et assumées, rien à reprendre pour l'instant.
- Fonction exponentielle — acquis et disponible. On s'en servira comme socle pour aller plus loin.
- Suites numériques — réponses justes, données avec assurance : c'est un vrai point d'appui pour la suite.
...
|---:|---|---|---|---|---|
| 1 | Suites numériques : du sens de variation à la récurrence | Rédaction et raisonnement | Excellence | | |
...
- **Séance 1** — Rédiger la démonstration du sens de variation d'une suite géométrique, puis établir qu'une suite peut croître sans jamais dépasser une valeur.
...
|---:|---|---|:---:|---|
| 8 | Dérivation | Distinguer le signe de la dérivée et le signe de la fonction | 2/4 | Le signe de f' renseigne sur le sens de variation de f, jamais sur le signe de f. Ce sont deux informations indépendantes. |
...
| Suites numériques | Acquis disponible | | |
