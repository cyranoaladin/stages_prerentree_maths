# Terminale Spécialité Mathématiques — Livret individuel — Rostom Fekih
...
| Réussite hésitante | Dérivation | **CONSOLIDER** |
| Acquis disponible | Second degré · Fonction exponentielle · Suites numériques · Produit scalaire | **ENTRETENIR** |
...
### Dérivation — 100 % · Réussite hésitante · **CONSOLIDER**
...
|---:|---|---|---|
| 1 | Dérivation | **CONSOLIDER** | Les réponses sont justes mais l'hésitation se sent encore. On organise un entraînement espacé, sans réenseigner ce qui est déjà compris. |
...
- Suites numériques — acquis et disponible. On s'en servira comme socle pour aller plus loin.
- Produit scalaire — réponses justes, données avec assurance : c'est un vrai point d'appui pour la suite.
