...
|---:|---:|---|---|---|
| 1 | item 4 | Second degré | Tenir compte du signe du coefficient dominant dans le tableau de signes | réponse fausse |
| 2 | item 14 | Suites numériques | Calculer un terme d'une suite géométrique | réponse fausse |
| 3 | item 15 | Suites numériques | Déterminer le sens de variation d'une suite géométrique par sa raison | réponse fausse |
| 4 | item 16 | Suites numériques | Étudier le sens de variation d'une suite définie par récurrence | réponse fausse |
| 5 | item 7 | Dérivation | Déduire les variations du signe de la dérivée | réponse fausse |
| 6 | item 12 | Fonction exponentielle | Utiliser la stricte positivité de la fonction exponentielle | réponse fausse |
| 7 | item 17 | Produit scalaire | Calculer un produit scalaire par les coordonnées | réponse fausse |
