# Terminale Spécialité Mathématiques — Cahier des cinq séances — Adam Zahouani
...
| 2 | Fonction exponentielle : exposants, équations, vers le logarithme | Installer les repères indispensables sur les suites numériques. | Installer |
| 3 | Second degré : discriminant, signe du trinôme, tableau de signes | Poser les définitions et les gestes de base en dérivation. | Installer |
...
> **Piège.** Additionne les exposants au lieu de les soustraire lors de la division.
...
Installer les repères indispensables sur les suites numériques.

L'entraînement collectif porte sur fonction exponentielle ; ton exercice personnel, plus bas, porte sur suites numériques. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Ne calcule pas le signe de $u_{n+1} - u_n$ avant de conclure.
...
Poser les définitions et les gestes de base en dérivation.
...
> **Piège.** Inverse le lien entre le signe de f' et le sens de variation.
...
> **Piège.** Confond le signe de la dérivée avec le signe de la fonction elle-même.
