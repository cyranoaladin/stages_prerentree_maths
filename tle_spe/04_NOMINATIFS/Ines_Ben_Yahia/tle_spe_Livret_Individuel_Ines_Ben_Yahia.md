...
**Aucune conclusion n'est donc formulée à la place de l'élève.** Ni point fort, ni priorité, ni parcours : tout cela se décide après le diagnostic de la séance 1.

## 2. Le diagnostic de la séance 1

Un positionnement est passé en début de séance 1, dans les mêmes conditions que celui de la cohorte : mêmes items, même déclaration de certitude de 1 à 4.

| Étape | Quand | Qui |
|---|---|---|
| Passation du positionnement (18 items) | Séance 1, 25 premières minutes | Élève |
| Dépouillement et report ci-dessous | Séance 1, pendant l'entraînement différencié | Enseignant |
| Attribution du parcours de la séance 2 | Fin de séance 1 | Enseignant |
| Livret complété à l'identique des autres | Avant la séance 2 | Enseignant |

En attendant, l'élève suit le **parcours maîtrise** de la séance 1 : c'est le parcours médian, qui n'anticipe ni un niveau élevé ni des lacunes.

## 3. Grille de report du diagnostic

À remplir en séance 1, puis à reporter dans un livret complet.

| Domaine | Réussite | Certitude moyenne | Situation dans la matrice |
|---|---:|---:|---|
| Second degré | | | |
| Dérivation | | | |
...
**Matrice de lecture, identique à celle des autres livrets :**
...
| 5 | Produit scalaire vers l'espace, probabilités, Python, évaluation | à définir après la séance 1 | à définir |
...
---
_Source pédagogique unique : `stage_prerentree_terminale_maths.md`. Ce livret ne comporte aucun diagnostic reporté : il en organise l'établissement._
