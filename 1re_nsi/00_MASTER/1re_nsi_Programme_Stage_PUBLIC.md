---
title: "Programme public - Stage Première NSI"
...
|---:|---|---|---|
| 1 | Comprendre l’exécution | variables, types, affectation, booléens, `if` | premier programme commenté |
| 2 | Automatiser | `for`, `range`, `while`, compteurs, accumulateurs | outils d’analyse d’une liste |
| 3 | Structurer et fiabiliser | fonctions, paramètres, `return`, `None`, tests | module de fonctions testées |
