---
title: "Dossier individuel Ahmad BELDI Première NSI"
...
<div class="subtitle">Ahmad BELDI - Première NSI</div>
...
| 2 | maîtriser `range`, compteur et somme | valeurs de `range` écrites | boucle sans erreur de borne |
| 3 | distinguer paramètre, retour et `None` | gabarit de fonction | 3 fonctions autonomes |
