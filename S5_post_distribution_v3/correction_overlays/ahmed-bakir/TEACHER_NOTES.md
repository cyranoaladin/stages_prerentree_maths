# Notes de correction — Ahmed BAKIR

**Entrée en Seconde générale et technologique — Mathématiques.** Document de travail enseignant. Il ne remplace aucun livret et ne modifie aucune question.
...
| | points disponibles |
| --- | ---: |
| consolidation des acquis de l'année N-1 | 20.00 |
| passerelles vers l'année N | 0.00 |
...
La saisie se fait critère par critère, dans `responses/responses_v3_TEMPLATE_ahmed-bakir.json`. Un code d'erreur ne se porte que sur le critère effectivement échoué.
