# Notes de correction — Sarah BARGAOUI
...
- `3E_SARAH_BARGAOUI_B2_c3` (B2, 0.50 pt) — M3_TRIGO_SIN_BRIDGE
...
La saisie se fait critère par critère, dans `responses/responses_v3_TEMPLATE_sarah-bargaoui.json`. Un code d'erreur ne se porte que sur le critère effectivement échoué.
