# Notes de correction — Fares DARGHOUTH

**Entrée en Quatrième — Mathématiques.** Document de travail enseignant. Il ne remplace aucun livret et ne modifie aucune question.
...
La saisie se fait critère par critère, dans `responses/responses_v3_TEMPLATE_fares-darghouth.json`. Un code d'erreur ne se porte que sur le critère effectivement échoué.
