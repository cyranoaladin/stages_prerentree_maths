# Terminale NSI — Tableau de bord enseignant
...
|---|---|---:|---|---|---|---|
| Adam Zahouani | NSI | 28,6 % | Types construits, Programmation, Données en tables | Représentation binaire, Booléens et logique, Algorithmique | — | Architecture et systèmes |
...
| Élève | Représentation binaire | Booléens et logique | Types construits | Programmation | Algorithmique | Données en tables | Architecture et systèmes |
|---|---:|---:|---:|---:|---:|---:|---:|
| Adam Zahouani | 0 % | 33,3 % | 50 % | 16,7 % | 0 % | 0 % | 100 % |
...
- **Adam Zahouani** : [livret](../05_NOMINATIFS/Adam_Zahouani/tle_nsi_Livret_Individuel_Adam_Zahouani.md) · [remédiation élève](../05_NOMINATIFS/Adam_Zahouani/tle_nsi_Remediation_Ciblee_Adam_Zahouani_ELEVE.md) · [corrigé enseignant](../05_NOMINATIFS/Adam_Zahouani/tle_nsi_Remediation_Ciblee_Adam_Zahouani_PROF_Corrige.md)
