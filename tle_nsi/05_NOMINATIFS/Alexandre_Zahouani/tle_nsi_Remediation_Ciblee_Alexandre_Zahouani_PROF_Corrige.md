...
**Ordre de traitement.** Types construits (CONFRONTER) → Algorithmique (CONFRONTER) → Données en tables (CONFRONTER) → Représentation binaire (INSTALLER) → Programmation (INSTALLER)
