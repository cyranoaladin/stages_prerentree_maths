# Terminale NSI — Cahier des cinq séances — Yassine Ben Hassine
...
|---:|---|---|:---:|
| 1 | Représentation des données et booléens | Rectifier une certitude erronée en représentation binaire. Faire apparaître, puis lever, l'idée fausse installée sur les types construits. | Confronter |
| 2 | Types construits : tableaux, dictionnaires, mutabilité | Reconstruire une notion tenue pour acquise en programmation. | Confronter |
| 3 | Programmation : fonctions, retour, portée, boucles | Rectifier une certitude erronée en algorithmique. | Confronter |
| 4 | Algorithmique : préconditions, recherche, tris, coût | Faire apparaître, puis lever, l'idée fausse installée sur les booléens. | Confronter |
| 5 | Données en tables, bases de données, systèmes, évaluation | Reconstruire une notion tenue pour acquise sur les données en tables. | Confronter |
...
Rectifier une certitude erronée en représentation binaire. Faire apparaître, puis lever, l'idée fausse installée sur les types construits.

L'entraînement collectif porte sur représentation des données et booléens ; ton exercice personnel, plus bas, porte sur représentation binaire. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Vaut 12 : oublie le bit des unités.
...
> **Piège.** Ne compte que le chiffre F et oublie le 1 des « seizaines ».
...
Reconstruire une notion tenue pour acquise en programmation.

L'entraînement collectif porte sur types construits ; ton exercice personnel, plus bas, porte sur programmation. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Une fonction sans return est valide ; elle ne provoque pas d'erreur.
...
> **Piège.** Compte le nombre d'itérations au lieu de la somme.
...
Rectifier une certitude erronée en algorithmique.
...
> **Piège.** Correspond à une recherche séquentielle, pas dichotomique.
...
Faire apparaître, puis lever, l'idée fausse installée sur les booléens.

L'entraînement collectif porte sur algorithmique ; ton exercice personnel, plus bas, porte sur booléens et logique. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Confond une expression booléenne avec une absence de valeur.
...
Reconstruire une notion tenue pour acquise sur les données en tables.
...
> **Piège.** Une ligne n'est qu'un enregistrement du fichier, pas le fichier.
