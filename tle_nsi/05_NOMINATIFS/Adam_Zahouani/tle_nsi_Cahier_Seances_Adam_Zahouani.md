# Terminale NSI — Cahier des cinq séances — Adam Zahouani
...
|---:|---|---|:---:|
| 1 | Représentation des données et booléens | Rectifier une certitude erronée sur les données en tables. Faire apparaître, puis lever, l'idée fausse installée en programmation. | Confronter |
| 2 | Types construits : tableaux, dictionnaires, mutabilité | Reconstruire une notion tenue pour acquise sur les types construits. | Confronter |
| 3 | Programmation : fonctions, retour, portée, boucles | Installer les repères indispensables en représentation binaire. | Installer |
| 4 | Algorithmique : préconditions, recherche, tris, coût | Poser les définitions et les gestes de base en algorithmique. | Installer |
| 5 | Données en tables, bases de données, systèmes, évaluation | Construire les premiers automatismes sur les booléens. | Installer |
...
Rectifier une certitude erronée sur les données en tables. Faire apparaître, puis lever, l'idée fausse installée en programmation.
...
> **Piège.** L'attribut correspond à une colonne, pas à une ligne.
...
> **Piège.** append est une méthode des listes, pas des dictionnaires.
...
L'entraînement collectif porte sur programmation ; ton exercice personnel, plus bas, porte sur représentation binaire. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
Poser les définitions et les gestes de base en algorithmique.
...
> **Piège.** La dichotomie fonctionne quelle que soit la parité de la taille.
...
Construire les premiers automatismes sur les booléens.

L'entraînement collectif porte sur données en tables, bases de données, systèmes, évaluation ; ton exercice personnel, plus bas, porte sur booléens et logique. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** A OU B est alors vrai grâce à B.
