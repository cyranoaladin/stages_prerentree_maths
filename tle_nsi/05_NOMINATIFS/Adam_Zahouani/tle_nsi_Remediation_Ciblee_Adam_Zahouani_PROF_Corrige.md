...
| 3 | item 10 | Programmation | Distinguer effet de bord et valeur renvoyée | réponse fausse |
| 4 | item 11 | Programmation | Maîtriser les bornes de range | réponse fausse |
| 5 | item 12 | Programmation | Construire un accumulateur dans une boucle | réponse fausse |
| 6 | item 15 | Données en tables | Distinguer enregistrement et descripteur | réponse fausse |
| 7 | item 16 | Données en tables | Nommer les opérations sur une table | réponse fausse |
| 8 | item 1 | Représentation binaire | Convertir un entier de la base 10 vers la base 2 | réponse fausse |
| 9 | item 2 | Représentation binaire | Convertir entre base 16 et base 10 | réponse fausse |
| 10 | item 4 | Booléens et logique | Maîtriser les tables de vérité de la conjonction et de la disjonction | réponse fausse |
| 11 | item 13 | Algorithmique | Connaître la précondition de la recherche dichotomique | réponse fausse |
| 12 | item 14 | Algorithmique | Évaluer le coût d'un algorithme de recherche | réponse fausse |
