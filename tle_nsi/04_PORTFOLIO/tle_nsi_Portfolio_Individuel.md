...
### Séance 5 — Données en tables et systèmes
...
## 3. Mon carnet de bugs

Une ligne par bug rencontré. C'est la partie la plus utile du portfolio.

| # | Le message ou le comportement | Ce qui n'allait pas | Comment je l'ai trouvé |
|---:|---|---|---|
| 1 | | | |
| 2 | | | |
| 3 | | | |
...
Une des habitudes du stage : prédire avant d'exécuter. Note ici ton score.

| Séance | Prédictions justes | Total | Écart le plus instructif |
|---:|---:|---:|---|
| 1 | | | |
| 2 | | | |
| 3 | | | |
...
Coche ceux que tu fais désormais sans y penser.
