# Dossier enseignant — Noa MANIACI (Entrée en Seconde générale et technologique, Mathématiques)
...
2. Lancer :
   ...
   ```
   python3 S5_cloture/tools/analyze_s5.py --student noa-maniaci --responses <fichier>
   ```
