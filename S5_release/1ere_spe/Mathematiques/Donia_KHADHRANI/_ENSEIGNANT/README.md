# Dossier enseignant — Donia KHADHRANI (Entrée en Première générale — Spécialité mathématiques, Mathématiques)
...
2. Lancer :
   ...
   ```
   python3 S5_cloture/tools/analyze_s5.py --student donia-khadhrani --responses <fichier>
   ```
