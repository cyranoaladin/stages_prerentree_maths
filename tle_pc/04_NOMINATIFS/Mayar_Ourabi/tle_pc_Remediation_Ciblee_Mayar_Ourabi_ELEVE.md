# Terminale Spécialité Physique-Chimie — Plan de remédiation ciblée — Mayar Ourabi (Élève)
...
### Comment cette feuille a été construite

Chaque exercice ci-dessous reprend **une compétence précise** que ton positionnement a signalée. Ce n'est pas une feuille d'exercices générale : c'est la tienne. Les exercices sont classés dans l'ordre de tes priorités.

### Consignes

- J'écris la propriété, la relation ou la précondition utilisée **avant** de calculer ou de coder.
- J'indique ma certitude de 1 à 4 pour chaque exercice.
- J'effectue un contrôle avant de déclarer une certitude de 4.
- Je ne consulte le corrigé qu'après une tentative complète.

---

## Exercice 1 — Énergie

*Compétence visée : Calculer une énergie cinétique.*
...
*Compétence visée : Calculer le travail d'une force.*
...
*Compétence visée : Relier longueur d'onde, célérité et fréquence.*

**Une onde sonore de fréquence $\SI{440}{\hertz}$ se propage dans l'air à $\SI{340}{\metre\per\second}$. Calculer sa longueur d'onde, puis celle d'un son de $\SI{880}{\hertz}$ dans le même milieu.**
...
*Compétence visée : Distinguer ce qui dépend de la source et ce qui dépend du milieu.*
...
*Compétence visée : Identifier le réactif limitant.*
...
*Compétence visée : Lire un couple oxydant-réducteur.*
...
*Compétence visée : Appliquer la définition de Brønsted.*
...
*Compétence visée : Relier pH et concentration en ions oxonium.*
...
*Compétence visée : Reconnaître les conditions d'une chute libre.*
...
*Compétence visée : Situer l'image d'un objet à l'infini.*
...
*Compétence visée : Utiliser les rayons particuliers d'une lentille.*
...
*Compétence visée : Associer un groupe caractéristique à sa famille.*
...
*Compétence visée : Identifier une famille à partir d'une formule semi-développée.*
