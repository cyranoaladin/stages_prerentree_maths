# Terminale Spécialité Physique-Chimie — Cahier des cinq séances — Melek Smida
...
|---:|---|---|:---:|
| 1 | Transformations chimiques : avancement, réactif limitant, oxydo-réduction | Rectifier une certitude erronée en mécanique. | Confronter |
| 2 | Mécanique : vecteur vitesse, forces, vers la deuxième loi de Newton | Faire apparaître, puis lever, l'idée fausse installée sur les transformations chimiques. | Confronter |
| 3 | Énergie : travail, énergies cinétique et potentielle, énergie mécanique | Stabiliser l'acquis encore fragile sur l'énergie. | Consolider |
| 4 | Ondes et optique : période, célérité, longueur d'onde, lentilles minces | Établir le niveau réel en électricité avant de choisir une remédiation. | Diagnostiquer |
| 5 | Électricité, chimie organique, mesure et incertitudes, évaluation | Contrôler un résultat par son ordre de grandeur et par le nombre de chiffres significatifs, et justifier le rejet d'une valeur. | Entretenir |
...
**Ton point personnel pendant le temps différencié :** Mécanique.  
...
Rectifier une certitude erronée en mécanique.

L'entraînement collectif porte sur transformations chimiques ; ton exercice personnel, plus bas, porte sur mécanique. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Ajoute une force que la définition même de la chute libre exclut.
...
D'ici la première séance, repère une question en mécanique dont la réponse te paraît évidente : on la mettra à l'épreuve ensemble.
...
Faire apparaître, puis lever, l'idée fausse installée sur les transformations chimiques.

L'entraînement collectif porte sur mécanique ; ton exercice personnel, plus bas, porte sur transformations chimiques. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Compare directement les quantités initiales sans les diviser par les coefficients stœchiométriques.
...
**2. Transformations chimiques — Appliquer la définition de Brønsted.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une question laissée sans réponse.
...
**3. Transformations chimiques — Relier pH et concentration en ions oxonium.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une question laissée sans réponse.
...
**4. Transformations chimiques — Distinguer oxydant et réducteur.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réussi avec une certitude de 2/4.

Dans la réaction $\ce{Zn + Cu^2+ -> Zn^2+ + Cu}$, identifier l'oxydant et le réducteur, puis écrire les deux demi-équations électroniques.
...
> **Méthode.** Le réducteur **cède** des électrons, l'oxydant les **capte**. Un transfert de protons relève d'une réaction acide-base, pas d'une oxydo-réduction.
...
Note deux ou trois réflexes que tu utilises sur les transformations chimiques : les écrire permettra de voir lequel bifurque.
...
Stabiliser l'acquis encore fragile sur l'énergie.
...
bas ? Utiliser la conservation de l'énergie mécanique.
...
**Exercice 6.** Une caisse est tirée sur $\SI{10}{\metre}$ par une force de $\SI{50}{\newton}$
faisant un angle de $30°$ avec l'horizontale, dans le sens du déplacement. Calculer le
...
**1. Énergie — Calculer une énergie cinétique.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réussi avec une certitude de 3/4.
...
**2. Énergie — Calculer le travail d'une force.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une réussi avec une certitude de 2/4.
...
Refais régulièrement un exercice court sur l'énergie, même réussi : c'est la répétition espacée qui transforme « je crois » en « je sais ».
...
**Ton point personnel pendant le temps différencié :** Électricité.  
...
Établir le niveau réel en électricité avant de choisir une remédiation.

L'entraînement collectif porte sur ondes et optique ; ton exercice personnel, plus bas, porte sur électricité. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
**1. Électricité — Calculer une puissance et une énergie électriques.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une question laissée sans réponse.

Un appareil alimenté sous $\SI{230}{\volt}$ est traversé par un courant de $\SI{0.5}{\ampere}$. Calculer sa puissance, puis l'énergie consommée en 2 heures, en joules puis en kilowattheures.
...
> **Méthode.** $P = U \times I$, en watts. L'énergie s'obtient en multipliant par la durée : en joules si la durée est en secondes, en wattheures si elle est en heures.

**2. Électricité — Quantifier l'énergie dissipée par effet Joule.** Cet exercice est là parce que, au positionnement, la question correspondante a donné une question laissée sans réponse.

Un résistor de $\SI{100}{\ohm}$ est traversé par un courant de $\SI{0.2}{\ampere}$ pendant 5 minutes. Calculer la puissance dissipée par effet Joule, puis l'énergie correspondante.
...
> **Méthode.** Dans un conducteur ohmique, la puissance dissipée vaut $P = R I^2$. L'énergie dissipée s'obtient en multipliant par la durée.
