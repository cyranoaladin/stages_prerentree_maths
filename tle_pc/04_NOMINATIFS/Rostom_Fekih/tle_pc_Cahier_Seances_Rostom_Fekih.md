# Terminale Spécialité Physique-Chimie — Cahier des cinq séances — Rostom Fekih
...
|---:|---|---|:---:|
| 1 | Transformations chimiques : avancement, réactif limitant, oxydo-réduction | Rectifier une certitude erronée sur l'énergie. | Confronter |
| 2 | Mécanique : vecteur vitesse, forces, vers la deuxième loi de Newton | Faire apparaître, puis lever, l'idée fausse installée sur les ondes. | Confronter |
| 3 | Énergie : travail, énergies cinétique et potentielle, énergie mécanique | Reconstruire une notion tenue pour acquise en mécanique. | Confronter |
| 4 | Ondes et optique : période, célérité, longueur d'onde, lentilles minces | Rectifier une certitude erronée sur les transformations chimiques. | Confronter |
| 5 | Électricité, chimie organique, mesure et incertitudes, évaluation | Installer les repères indispensables en optique. | Installer |
...
Rectifier une certitude erronée sur l'énergie.
...
**Ton point personnel pendant le temps différencié :** Ondes et signaux.  
**Ta piste :** Confronter. Écris d'abord ce que tu croyais, puis ce qui l'a mis en défaut. C'est cette trace-là qui empêche l'erreur de revenir.

## Aujourd'hui, tu vas…

Faire apparaître, puis lever, l'idée fausse installée sur les ondes.

L'entraînement collectif porte sur mécanique ; ton exercice personnel, plus bas, porte sur ondes et signaux. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Piège.** Fait dépendre la fréquence des propriétés du milieu traversé.

> **Méthode.** La fréquence est imposée par la source : elle ne change jamais au passage d'un milieu à un autre. C'est la célérité qui dépend du milieu, et la longueur d'onde qui s'ajuste.
...
Reconstruire une notion tenue pour acquise en mécanique.

L'entraînement collectif porte sur énergie ; ton exercice personnel, plus bas, porte sur mécanique. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
**Question 0.** Tu tires une valise à roulettes sur un sol horizontal, sur
$\SI{20}{\metre}$. Que vaut le travail du **poids** de la valise ?

Ma réponse : ..................................................  Ma certitude : $\square$1 $\square$2 $\square$3 $\square$4

Maintenant, réponds à ceci : de combien la valise est-elle montée ou descendue ?

....................................................................................................

Et si le poids avait travaillé, où serait passée cette énergie ?
...
Ne cherche pas à « réviser plus » en mécanique : viens avec tes certitudes, ce sont elles qu'on va tester.
...
Rectifier une certitude erronée sur les transformations chimiques.
...
Installer les repères indispensables en optique.

L'entraînement collectif porte sur électricité, chimie organique, mesure et incertitudes, évaluation ; ton exercice personnel, plus bas, porte sur optique. Les deux sont à traiter : le premier avec le groupe, le second pendant le temps différencié.
...
> **Exemple.** Un conducteur ohmique de $\SI{100}{\ohm}$ est traversé par
> $\SI{0.15}{\ampere}$.
>
> $$U = R \times I = 100 \times 0{,}15 = \SI{15}{\volt}$$
> $$P = U \times I = 15 \times 0{,}15 = \SI{2.3}{\watt}$$
>
> **Contrôle.** On peut aussi écrire $P = R I^{2} = 100 \times 0{,}15^{2}$, soit
> $\SI{2.3}{\watt}$ : les deux chemins donnent le même résultat, c'est la vérification.
>
> **Chiffres significatifs.** Les données ont deux chiffres significatifs ; le résultat en
> a deux aussi.
...
> **Piège.** Confond le point de convergence des rayons avec le centre de la lentille.
...
> **Piège.** Décrit le comportement d'un rayon passant par le foyer objet.
