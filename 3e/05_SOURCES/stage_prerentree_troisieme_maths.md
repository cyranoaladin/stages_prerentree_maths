...
## Mathématiques — Entrée en Troisième
...
> « Il faut faire quelque chose avec les trois nombres » remplace
...
# 7. Progression détaillée des cinq séances
...
|   25-45 min | Conflit cognitif sur les signes | Comparer $(-2)\times(-3)$, $(-2)\times3$, $2\times(-3)$                                    | Tableau de signes, gains/pertes, contre-exemples            | Selim justifie le signe sans réciter mécaniquement |
|   45-65 min | Fractions                       | Représenter puis calculer $2/3\times9/4$                                                   | Rectangles fractionnés ; simplification avant/après produit | Aucun élève n’additionne les dénominateurs         |
...
* confusion entre $2^5$ et $2\times5$ ;
...
|   10-25 min | Conflit géométrique   | Triangle (6)-(8)-(10) : pourquoi $6+8\neq10$ mais $6^2+8^2=10^2$ ? | Carrés découpés       | Les élèves comprennent l’objet « carré d’une longueur » |
...
| 105-115 min | Raisonnement commun   | Rédiger données → propriété → calcul → conclusion                  | Gabarit de preuve     | Raisonnement complet                                    |
| 115-118 min | Trace écrite          | Théorème et contrôle de vraisemblance                              | Fiche méthode         | Hypoténuse nommée                                       |
| 118-120 min | Exit ticket           | Choisir entre deux relations proposées                             | Individuel            | Justification courte                                    |
...
| Élève     | Travail personnalisé                                                                                                                  |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| **Sarah** | Consolider le rapport puis traiter $\cos \theta=0{,}5$ ; comprendre pourquoi l’angle vaut $60^\circ$, non $45^\circ$                  |
...
# 8. Différenciation réaliste et non chronophage

## 8.1 Principe général

La différenciation ne consiste pas à produire une fiche totalement différente pour chaque élève. Chaque séance utilise :

* une même situation initiale ;
* une même trace écrite ;
* une fiche unique ;
* trois parcours de difficulté ;
* quatre cartes-aides graduées ;
* des objectifs individuels consignés dans la grille de suivi.

## 8.2 Organisation d’une fiche

### Zone A — Tronc commun

* un exemple à comprendre ;
* une erreur à analyser ;
* deux exercices indispensables ;
* une question de contrôle de vraisemblance.

### Zone B — Parcours Consolidation

* nombres simples ;
* schémas ou étapes fournis ;
* une difficulté à la fois ;
* vérification après deux exercices.

### Zone C — Parcours Maîtrise

* données moins immédiates ;
* absence d’étapes intermédiaires ;
* justification obligatoire ;
* problème de transfert.

### Zone D — Parcours Approfondissement

* contre-exemple ;
* généralisation ;
* démonstration ;
* anticipation de Troisième ;
* problème ouvert.

Les termes « Consolidation », « Maîtrise » et « Approfondissement » désignent les tâches, non les élèves. Un même élève peut changer de parcours selon la compétence.

## 8.3 Cartes-aides graduées

| Carte              | Contenu                                                                  |
| ------------------ | ------------------------------------------------------------------------ |
| **A — Comprendre** | Reformulation de la consigne et identification de la grandeur recherchée |
| **B — Choisir**    | Deux propriétés ou méthodes possibles                                    |
| **C — Commencer**  | Première étape seulement                                                 |
| **D — Vérifier**   | Moyen de contrôler le résultat sans donner la réponse                    |

L’élève note la carte utilisée. Cela permet de distinguer :

* réussite autonome ;
* réussite avec aide légère ;
* réussite avec guidage important.

## 8.4 Variables didactiques

| Domaine          | Variables permettant de différencier                       |
| ---------------- | ---------------------------------------------------------- |
| Relatifs         | nombre de facteurs, parenthèses, priorité opératoire       |
| Fractions        | simplification immédiate ou non, signes, division          |
| Puissances       | exposants positifs puis négatifs, notation scientifique    |
| Calcul littéral  | une ou deux distributivités, coefficients relatifs         |
| Équations        | inconnue dans un membre puis dans les deux membres         |
| Proportionnalité | retour à l’unité, coefficient décimal, problème composé    |
| Pythagore        | hypoténuse recherchée ou connue, valeur exacte ou arrondie |
| Thalès           | figure standard puis papillon                              |
| Trigonométrie    | côté recherché, angle recherché, choix du rapport          |
| Statistiques     | effectifs simples, coefficients, données regroupées        |
| Probabilités     | une étape puis deux étapes                                 |

## 8.5 Groupes de besoin tournants

Avec quatre élèves :

* **atelier enseignant**, 12 à 15 minutes ;
* **atelier entraînement autonome**, corrigé partiellement ;
* **atelier transfert ou approfondissement**.

Exemple en séance 3 :

1. Selim et Fares avec l’enseignant sur la relation de Pythagore ;
2. Sarah sur une longueur manquante et la rédaction ;
3. Amine sur un exercice autonome avec justification et certitude ;
4. rotation au bout de 12 minutes.

Fares ne doit pas devenir le tuteur permanent du groupe. Ses points forts justifient des tâches d’approfondissement, mais ses conceptions erronées en géométrie et trigonométrie nécessitent aussi un véritable accompagnement.

## 8.6 Rituel réutilisable

Chaque réponse comporte trois lignes :
...
Ma justification ou mon contrôle :
________________________________________
```

Les quatre questions quotidiennes sont :

1. une notion de la veille ;
2. une notion plus ancienne ;
3. un automatisme numérique ;
4. une question de transfert.

---

# 9. Plans d’action individualisés

## 9.1 Sarah Bargaoui

Sarah dispose d’un bon socle en relatifs, fractions et puissances, mais doit installer ou consolider les équations, la proportionnalité, Pythagore, la trigonométrie et les statistiques. Son erreur de calcul littéral est d’autant plus prioritaire qu’elle a été commise avec une confiance relativement élevée. 

| Élément               | Plan                                                                                                                                 |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| **Priorité 1**        | Réduction d’expressions et gestion des constantes négatives                                                                          |
| **Priorité 2**        | Équations avec regroupement des constantes                                                                                           |
| **Priorité 3**        | Longueur manquante avec Pythagore                                                                                                    |
| **Priorité 4**        | Interprétation d’un cosinus et calcul d’un angle                                                                                     |
| **Priorité 5**        | Moyenne et contrôle de la grandeur demandée                                                                                          |
| **Points d’appui**    | Relatifs, fractions, puissances                                                                                                      |
| **Remédiations**      | Jetons algébriques, balance, schéma de Pythagore, représentation de la moyenne comme partage                                         |
| **Indicateurs**       | 3 réductions consécutives justes ; 3 équations vérifiées ; 2 problèmes de Pythagore sans confusion ; moyenne calculée et interprétée |
| **Conseil Troisième** | Écrire la relation ou la formule avant d’insérer les nombres                                                                         |
| **Après le stage**    | 3 séances de 15 minutes par semaine : algèbre, géométrie, données                                                                    |

### Vigilance particulière

Sarah ne doit pas être assignée au parcours de consolidation en fractions simplement parce que le groupe travaille ce domaine. Elle peut utiliser ce temps pour :

* fractions avec signes ;
* division de fractions ;
* notation scientifique ;
* justification de procédures.

---

## 9.2 Selim Mansouri

Selim présente quatre conceptions erronées prioritaires : signe d’un produit, distributivité, proportionnalité et Pythagore. Les fractions, la seconde équation et une partie de la trigonométrie n’ont pas été suffisamment évaluées. 

| Élément               | Plan                                                                                                                                   |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| **Priorité 1**        | Règle des signes dans les produits et quotients                                                                                        |
| **Priorité 2**        | Distributivité complète                                                                                                                |
| **Priorité 3**        | Retour à l’unité en proportionnalité                                                                                                   |
| **Priorité 4**        | Sens du théorème de Pythagore                                                                                                          |
| **À diagnostiquer**   | Multiplication de fractions, équation à deux membres, trigonométrie                                                                    |
| **Point d’appui**     | Puissances                                                                                                                             |
| **Remédiations**      | Tableaux de signes, modèle d’aire, tableaux de proportionnalité, carrés construits sur les côtés                                       |
| **Indicateurs**       | 5 produits relatifs sans erreur ; 4 développements complets ; 3 problèmes de proportionnalité ; 3 relations de Pythagore bien choisies |
| **Conseil Troisième** | Ne jamais choisir une opération uniquement parce que les nombres sont présents                                                         |
| **Après le stage**    | 10 minutes quotidiennes pendant deux semaines, puis trois entraînements hebdomadaires                                                  |

### Vigilance particulière

Les questions laissées vides doivent être diagnostiquées avant d’être enseignées. Une non-réponse peut correspondre à :

* une notion non étudiée ;
* une consigne mal comprise ;
* un manque de temps ;
* une stratégie d’évitement ;
* une connaissance non mobilisée.

---

## 9.3 Amine Mansouri

Amine réussit de nombreuses questions, mais déclare généralement une certitude 1. Son profil demande moins de réenseignement massif qu’un travail sur l’explicitation, la vérification et la confiance. Les fractions et la trigonométrie restent toutefois à situer. 

| Élément                  | Plan                                                                                                                                  |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------- |
| **Priorité 1**           | Vérifier que les réponses justes reposent sur une procédure comprise                                                                  |
| **Priorité 2**           | Réduction et signes des constantes                                                                                                    |
| **Priorité 3**           | Multiplication de fractions                                                                                                           |
| **Priorité 4**           | Installation de la trigonométrie                                                                                                      |
| **Objectif transversal** | Calibrer la confiance                                                                                                                 |
| **Points d’appui**       | Relatifs, puissances, équations, proportionnalité, Pythagore, statistiques                                                            |
| **Remédiations**         | Explication orale, exemple analogue, auto-correction, comparaison réponse–certitude                                                   |
| **Indicateurs**          | Justifier oralement 4 réponses ; passer d’une confiance 1 à 3 quand une procédure est maîtrisée ; maintenir au moins 80 % de réussite |
| **Conseil Troisième**    | La confiance doit s’appuyer sur une preuve : calcul de contrôle, substitution, estimation ou propriété                                |
| **Après le stage**       | Portfolio de réussites expliquées, deux exercices courts puis une verbalisation                                                       |

### Vigilance particulière

Il ne faut pas obliger Amine à augmenter artificiellement ses niveaux de certitude. L’objectif est une confiance **justifiée**, non une confiance élevée à tout prix.

---

## 9.4 Fares Laajili

Fares possède un socle solide dans six domaines, mais présente trois conceptions particulièrement nettes : multiplication erronée des fractions, usage arithmétique direct des côtés dans Pythagore et confusion entre cosinus et sinus. 

| Élément               | Plan                                                                                                    |
| --------------------- | ------------------------------------------------------------------------------------------------------- |
| **Priorité 1**        | Multiplier correctement deux fractions                                                                  |
| **Priorité 2**        | Reconstruire Pythagore à partir des carrés                                                              |
| **Priorité 3**        | Distinguer cosinus et sinus                                                                             |
| **Points d’appui**    | Relatifs, puissances, calcul littéral, équations, proportionnalité, statistiques                        |
| **Remédiations**      | Conflit cognitif, représentation d’aire, carrés géométriques, changement d’angle de référence           |
| **Indicateurs**       | 5 produits de fractions ; 3 problèmes de Pythagore ; identification correcte des rapports sur 4 figures |
| **Approfondissement** | Division de fractions, réciproque, Thalès, sinus, tangente, fonctions                                   |
| **Conseil Troisième** | Ne pas confondre rapidité et validation : contrôler la structure avant d’appliquer une règle            |
| **Après le stage**    | Un problème de transfert par semaine et réactivation espacée des trois erreurs initiales                |

---

# 10. Évaluation et suivi

## 10.1 Évaluation diagnostique
...
* les non-réponses ;
* le mini-diagnostic complémentaire ;
* l’entretien oral ;
* l’observation des premières procédures.

Aucune conclusion sur la vitesse de travail ne sera formulée, puisque la durée réelle n’a pas été mesurée.

## 10.2 Évaluation formative continue

À chaque séance :

* rituel cumulatif ;
* observation des procédures ;
* utilisation des cartes-aides ;
* problème de transfert ;
* exit ticket ;
* auto-évaluation ;
* mise à jour de la grille enseignant.

## 10.3 Échelle de maîtrise

|                   Niveau | Description                                                    |
| -----------------------: | -------------------------------------------------------------- |
|        **0 — Non situé** | Données insuffisantes ou question non traitée                  |
|   **1 — À reconstruire** | Conception erronée ou procédure non disponible                 |
| **2 — En consolidation** | Réussite avec aide ou sur cas simples                          |
|         **3 — Maîtrisé** | Réussite autonome et expliquée                                 |
|        **4 — Transféré** | Réussite dans une situation nouvelle ou justification générale |

## 10.4 Critères de réussite finale

### Critères communs

* au moins 75 % de réussite sur les notions prioritaires ;
* aucune conception erronée initiale reproduite avec certitude 4 ;
* capacité à expliquer au moins deux corrections ;
* choix de la propriété avant le calcul en géométrie ;
* unité et conclusion présentes ;
* niveau de confiance cohérent avec la procédure.

### Seuils individuels

| Élève | Critère prioritaire                                                    |
| ----- | ---------------------------------------------------------------------- |
| Sarah | Réduction, équation, Pythagore et moyenne réussis sans aide            |
| Selim | Suppression des quatre erreurs fortement installées                    |
| Amine | Maintien de la réussite avec justification et confiance mieux calibrée |
| Fares | Rectification complète des fractions, de Pythagore et du cosinus       |

## 10.5 Portfolio de stage

Chaque élève conserve :

1. le test initial ;
2. le mini-diagnostic ;
3. sa carte de priorités ;
4. les cinq fiches de séance ;
5. les cinq exit tickets ;
6. deux erreurs corrigées et expliquées ;
7. l’évaluation finale ;
8. la grille d’auto-évaluation ;
9. le plan de travail pour septembre.

---

# 11. Banque de supports et d’activités

## 11.1 Supports à préparer

| Code  | Support                                      |
| ----- | -------------------------------------------- |
| D0    | Mini-diagnostic complémentaire               |
| N1    | Cartes de signes                             |
| F1    | Rectangles fractionnés                       |
| F2    | Cartes de fractions équivalentes             |
| A1    | Modèle d’aire pour la distributivité         |
| A2    | Jetons algébriques                           |
| E1    | Balance d’équation                           |
| P1    | Carrés de Pythagore à découper               |
| P2    | Figures codées Pythagore/Thalès              |
| T1    | Triangles mobiles pour la trigonométrie      |
| T2    | Carte SOH-CAH-TOA                            |
| S1    | Cubes ou jetons pour représenter une moyenne |
| S2    | Séries statistiques et histogrammes          |
| PR1   | Cartes de probabilités                       |
| C1-C4 | Cartes-aides graduées                        |
| M1    | Mini-tableaux effaçables                     |
| B1    | Grille de suivi enseignant                   |
| B2    | Grille d’auto-évaluation                     |
| EF    | Évaluation finale                            |

## 11.2 Activités concrètes
...
> Une seule production est correcte.
> Ne donne pas immédiatement la réponse. Construis un argument qui convaincrait l’auteur de l’autre production.
...
# 12. Annexes — modèles prêts à l’emploi

## Annexe A — Fiche type de séance

### Séance n° ___ — Thème : __________________________
...
**Lien avec la Troisième :**

---

| Phase              |  Durée | Activité commune | Différenciation | Preuve recueillie |
| ------------------ | -----: | ---------------- | --------------- | ----------------- |
| Rituel             | 10 min |                  |                 |                   |
| Activation         | 15 min |                  |                 |                   |
| Construction       | 20 min |                  |                 |                   |
| Entraînement guidé | 20 min |                  |                 |                   |
| Pause              |  5 min |                  |                 |                   |
| Ateliers           | 35 min |                  |                 |                   |
| Transfert          | 10 min |                  |                 |                   |
| Synthèse           |  3 min |                  |                 |                   |
...
## Annexe B — Fiche différenciée

### Tronc commun

1. Je comprends l’exemple.
2. J’identifie une erreur.
3. Je résous les deux exercices indispensables.
4. Je contrôle mon résultat.

### Parcours Consolidation

* [ ] J’utilise une représentation.
* [ ] Je demande une carte-aide si nécessaire.
* [ ] Je réussis deux exercices consécutifs.
* [ ] J’explique une étape.

### Parcours Maîtrise

* [ ] Je choisis seul la méthode.
* [ ] Je rédige la propriété utilisée.
* [ ] Je contrôle le résultat.
* [ ] Je résous un problème de transfert.

### Parcours Approfondissement

* [ ] Je produis un contre-exemple.
* [ ] Je généralise une procédure.
* [ ] Je traite une anticipation de Troisième.
* [ ] Je compare deux méthodes.
...
# 13. Exercices différenciés avec corrections
...
3. Calculer :
   $\frac56-\frac14$
4. Calculer :
   $-\frac35\times\frac{10}{9}$
5. Écrire $2^3\times2^5$ sous la forme d’une seule puissance.
...
7. Calculer :
   $$5-2[3-(-4)]$$
8. Calculer :
   $\frac7{12}\div\frac{14}{9}$
9. Écrire $0{,}00056$ en notation scientifique.
10. Rendre irréductible :
    $\frac{84}{126}$

### Approfondissement

11. Justifier, à l’aide de la distributivité, pourquoi le produit de deux nombres négatifs est positif.
...
6. $0{,}001$
7. $5-2\times7=-9$
8. $\frac7{12}\times\frac9{14}=\frac38$
9. $5{,}6\times10^{-4}$
10. (2/3)
...
5. Dans le triangle (ABC), $M\in[AB]$, $N\in[AC]$ et $MN\parallel BC$.
   On donne (AM=3), (AB=5) et $AN=4{,}2$. Calculer (AC).
6. Un triangle a pour côtés 5 cm, 7 cm et 9 cm. Est-il rectangle ?
7. Dans un triangle rectangle, le côté adjacent à l’angle $\theta$ mesure 6 cm et l’hypoténuse 10 cm. Calculer $\cos\theta$, puis estimer $\theta$.

### Approfondissement

8. L’hypoténuse d’un triangle rectangle mesure 12 cm et un angle aigu $35^\circ$. Calculer le côté adjacent.
...
6. $5^2+7^2=74\neq81=9^2$ : non
7. $\cos\theta=0{,}6$, donc $\theta\approx53^\circ$
8. $12\cos35^\circ\approx9{,}8$ cm
...
5. On définit (f(x)=3x-2). Calculer (f(5)) et déterminer l’antécédent de 7.
...
8. On lance une pièce équilibrée et un dé équilibré. Calculer la probabilité d’obtenir « face » et un nombre pair.
9. Construire un exemple de deux séries ayant la même moyenne mais des étendues différentes.

### Corrections

1. (9)
2. $(14\times2+10\times3)/5=11{,}6$
...
6. Dans une configuration de Thalès :
   $\frac35=\frac{4{,}2}{x}$
   déterminer (x).
...
9. Convertir $54\ \text{km/h}$ en $\text{m/s}$.
10. Un programme fixe (x=2), puis répète trois fois l’instruction $x\leftarrow2x+1$. Quelle est la valeur finale de (x) ?

## Correction

1. $84=2^2\times3\times7$
2. (2/3)
3. $7{,}2\times10^{-4}$
4. (13)
...
# 16. Recommandations didactiques et pédagogiques

## 16.1 Traiter d’abord les erreurs sûres

L’ordre de remédiation doit être :

1. réponse fausse avec confiance élevée ;
2. réponse fausse avec hésitation ;
3. réponse juste avec hésitation ;
4. réponse juste et sûre ;
5. non-réponse à diagnostiquer.

Une réponse fausse donnée avec certitude ne se corrige pas par la simple répétition de la règle. Il faut :

1. faire verbaliser la règle utilisée ;
2. produire un contre-exemple ;
3. faire apparaître la contradiction ;
4. reconstruire la notion ;
5. entraîner ;
6. réinterroger la même conception quelques jours plus tard.

## 16.2 Ne pas confondre absence de réponse et ignorance

Pour Selim et Amine, plusieurs domaines sont partiellement ou totalement non traités. Avant toute remédiation, l’enseignant doit demander :

* « Qu’as-tu compris de la question ? »
* « Quelle première étape aurais-tu tentée ? »
* « As-tu déjà rencontré cette notion ? »
* « Qu’est-ce qui t’a empêché de répondre ? »

## 16.3 Toujours faire nommer l’objet mathématique

Avant le calcul, l’élève complète une phrase :

* « Je cherche une longueur. »
* « Je cherche un angle. »
* « Je cherche une moyenne. »
* « Je cherche une valeur de (x). »
* « Je cherche un coefficient de proportionnalité. »

Cette verbalisation réduit les calculs mécaniques inadaptés.

## 16.4 Installer une procédure de contrôle

Chaque domaine possède un contrôle privilégié :

| Domaine          | Contrôle                                        |
| ---------------- | ----------------------------------------------- |
| Relatifs         | Estimation du signe                             |
| Fractions        | Ordre de grandeur et simplification             |
| Puissances       | Développement sur un petit exemple              |
| Calcul littéral  | Substitution d’une valeur                       |
| Équations        | Remplacement de (x) par la solution             |
| Proportionnalité | Vérification du coefficient                     |
| Pythagore        | Hypoténuse plus longue que les autres côtés     |
| Trigonométrie    | Rapport compris entre 0 et 1 pour sinus/cosinus |
| Moyenne          | Valeur comprise entre minimum et maximum        |
| Probabilité      | Valeur comprise entre 0 et 1                    |

## 16.5 Utiliser la confiance comme donnée pédagogique

La confiance ne doit pas être transformée en note.

À la correction :

* juste + confiance 4 : acquis disponible ;
* juste + confiance 1 : procédure à expliciter ;
* faux + confiance 1 : notion à installer ;
* faux + confiance 4 : conception à confronter prioritairement.

Pour Amine, le progrès attendu n’est pas de toujours cocher 4. Il doit apprendre à distinguer :

* « je devine » ;
* « j’ai une méthode mais je ne l’ai pas contrôlée » ;
* « j’ai une méthode et un contrôle » ;
* « je pourrais l’expliquer à quelqu’un ».

## 16.6 Alterner entraînement bloqué et exercices mélangés

* Au début de chaque reprise : plusieurs exercices de même structure.
* Dès que la procédure est stabilisée : exercices mélangés.
* En fin de séance : problème dans lequel le domaine n’est pas annoncé.

L’objectif est de passer de :

> « Je sais faire quand on me dit quelle méthode utiliser »

à :

> « Je reconnais moi-même la méthode pertinente ».

## 16.7 Maintenir une charge cognitive raisonnable

Pour Selim :

* une difficulté nouvelle à la fois ;
* figures déjà codées au début ;
* calculs simples pendant la reconstruction conceptuelle ;
* rédaction complétée progressivement.

Pour Fares :

* éviter les séries trop répétitives ;
* proposer rapidement des contre-exemples, preuves et transferts.

Pour Sarah :

* ne pas surentraîner les domaines déjà solides ;
* faire porter l’effort sur la modélisation et la vérification.

Pour Amine :

* valoriser les procédures explicitées ;
* ne pas interpréter automatiquement sa faible confiance comme une absence de maîtrise.

---

# 17. Poursuite recommandée après le stage

## Pendant le premier mois de Troisième

### Trois fois par semaine — 15 minutes

* 5 minutes d’automatismes ;
* 5 minutes sur une ancienne erreur ;
* 5 minutes sur un problème court.

### Une fois par semaine

Un exercice mêlant au moins deux domaines :
...
Effectuer un contrôle de suivi court sur :
...
# 18. Synthèse pédagogique finale

La progression collective retenue n’est pas la juxtaposition des quatre parcours imprimés dans les bilans. Elle est construite à partir de leurs intersections et de leur importance pour la Troisième :

1. **Calcul numérique et fractions** : besoin de diagnostic pour deux élèves et de rectification pour Fares ;
2. **Algèbre et équations** : difficulté commune sous des formes différentes ;
3. **Pythagore et raisonnement** : conception erronée très présente chez Selim et Fares ;
4. **Trigonométrie** : domaine non évalué ou fragile pour les quatre profils ;
5. **Statistiques, probabilités et synthèse** : consolidation, ouverture vers la Troisième et mesure des progrès.

Cette organisation permet :

* un cadre commun cohérent ;
* une différenciation effective ;
* la rectification des erreurs à forte confiance ;
* l’entretien des acquis solides ;
* une anticipation mesurée de la Troisième ;
* une progression directement exploitable avec un groupe de quatre élèves.

[1]: https://www.education.gouv.fr/bo/2026/Hebdo10/MENE2602912A "https://www.education.gouv.fr/bo/2026/Hebdo10/MENE2602912A"
[2]: https://eduscol.education.gouv.fr/6910/reperes-annuels-de-progression-et-attendus-de-fin-d-annee-du-cp-la-troisieme "https://eduscol.education.gouv.fr/6910/reperes-annuels-de-progression-et-attendus-de-fin-d-annee-du-cp-la-troisieme"
[3]: https://eduscol.education.gouv.fr/5736/ressources-d-accompagnement-du-programme-de-mathematiques-au-cycle-4 "https://eduscol.education.gouv.fr/5736/ressources-d-accompagnement-du-programme-de-mathematiques-au-cycle-4"
[4]: https://www.education.gouv.fr/bo/20/Hebdo31/MENE2018714A.htm "https://www.education.gouv.fr/bo/20/Hebdo31/MENE2018714A.htm"
