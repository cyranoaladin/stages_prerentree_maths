...
9. $5{,}6\times10^{-4}$
10. (2/3)
11. $(-a)\times0=(-a)\times(b+(-b))=(-a)\times b+(-a)\times(-b)$ (distributivité) ; or $(-a)\times0=0$ et $(-a)\times b=-ab$, donc $0=-ab+(-a)\times(-b)$, soit $(-a)\times(-b)=ab$, positif si (a,b>0)
12. Exemple : $\frac12\times\frac13=\frac16$, alors que la règle fausse donnerait $\frac1{2+3}=\frac15\neq\frac16$ : la règle est donc fausse
