...
5. Dans un triangle rectangle, $\cos\theta=0{,}5$. Déterminer la mesure de $\theta$.
...
8. Dans un triangle rectangle, l’hypoténuse mesure 10 cm, le côté adjacent à l’angle $\theta$ 6 cm et le côté opposé 8 cm. Calculer $\sin\theta$ et $\tan\theta$, puis vérifier que $\cos^2\theta+\sin^2\theta=1$.
