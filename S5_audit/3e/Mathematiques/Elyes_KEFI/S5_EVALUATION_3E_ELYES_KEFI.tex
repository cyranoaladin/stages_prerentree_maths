...
\usepackage{nexusS5}
\setnexusheader{Entrée en Troisième — Stage de pré-rentrée}{Évaluation finale — Elyes KEFI}
\begin{document}
\nexuscover{ÉVALUATION FINALE --- DIAGNOSTIC DE SORTIE}{Durée : 45 minutes}{Elyes KEFI}{Entrée en Troisième}{Mathématiques --- à traiter individuellement}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A5.}] Calculer $\dfrac{7}{9}\times\dfrac{3}{14}$ et simplifier.
\worklines{2}
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A6.}] Réduire $8x - 9 + 3x + 4$.
\worklines{2}
\par\vspace{1.2mm}
\end{enumerate}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{B4.}] On considère la série $5$ ; $12$ ; $8$ ; $15$ ; $10$.
\begin{enumerate}
