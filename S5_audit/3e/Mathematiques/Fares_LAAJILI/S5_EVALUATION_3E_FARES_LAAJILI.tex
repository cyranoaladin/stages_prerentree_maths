...
\usepackage{nexusS5}
\setnexusheader{Entrée en Troisième — Stage de pré-rentrée}{Évaluation finale — Fares LAAJILI}
\begin{document}
\nexuscover{ÉVALUATION FINALE --- DIAGNOSTIC DE SORTIE}{Durée : 45 minutes}{Fares LAAJILI}{Entrée en Troisième}{Mathématiques --- à traiter individuellement}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A5.}] Calculer $\dfrac{6}{25}\div\dfrac{3}{10}$ et simplifier.
\worklines{2}
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A6.}] Dans un triangle rectangle en $A$, on connaît le côté opposé à l'angle $\widehat{C}$ et l'hypoténuse. Quel rapport faut-il utiliser ? Écrire sa définition.
\worklines{2}
\par\vspace{1.2mm}
\end{enumerate}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{B4.}] Le triangle $ABC$ est rectangle en $A$, avec $AB = 20$ cm et $AC = 21$ cm.
\begin{enumerate}
\item Calculer $BC$.
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{C2.}] Le triangle $ABC$ est rectangle en $A$, avec $BC = 26$ cm et $AC = 10$ cm.
\begin{enumerate}
