...
\usepackage{nexusS5}
\setnexusheader{Entrée en Première générale — Spécialité mathématiques — Stage de pré-rentrée}{Évaluation finale — Donia KHADHRANI}
\begin{document}
\nexuscover{ÉVALUATION FINALE --- DIAGNOSTIC DE SORTIE}{Durée : 45 minutes}{Donia KHADHRANI}{Entrée en Première générale — Spécialité mathématiques}{Mathématiques --- à traiter individuellement}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A5.}] Soit $f(x) = 4x - 3$. Déterminer l'antécédent de $13$ en écrivant l'équation résolue.
\worklines{2}
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A6.}] Résoudre $-5x + 20 \ge 0$ et donner l'ensemble des solutions sous forme d'intervalle.
\worklines{2}
\par\vspace{1.2mm}
\end{enumerate}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{B4.}] On donne $A(-2\,;7)$ et $B(2\,;-1)$.
\begin{enumerate}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{C2.}] On donne $P(A) = 0{,}45$, $P(B) = 0{,}3$ et $P(A\cap B) = 0{,}15$.
\begin{enumerate}
