...
\usepackage{nexusS5}
\setnexusheader{Entrée en Première générale — Spécialité mathématiques — Stage de pré-rentrée}{Évaluation finale — Ahmad BELDI}
\begin{document}
\nexuscover{ÉVALUATION FINALE --- DIAGNOSTIC DE SORTIE}{Durée : 45 minutes}{Ahmad BELDI}{Entrée en Première générale — Spécialité mathématiques}{Mathématiques --- à traiter individuellement}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A5.}] Factoriser $49x^2 - 16$.
\worklines{2}
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A6.}] La courbe représentative de $f$ passe par le point de coordonnées $(-4\,;1)$. Écrire l'égalité correspondante, puis la phrase employant le mot « antécédent ».
\worklines{2}
\par\vspace{1.2mm}
\end{enumerate}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{C2.}] Un abonnement de $300$ TND augmente de $5\,\%$ par an. On pose $u_0 = 300$.
\begin{enumerate}
