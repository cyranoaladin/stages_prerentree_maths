...
\usepackage{nexusS5}
\setnexusheader{Entrée en Seconde générale et technologique — Stage de pré-rentrée}{Évaluation finale — Noa MANIACI}
\begin{document}
\nexuscover{ÉVALUATION FINALE --- DIAGNOSTIC DE SORTIE}{Durée : 45 minutes}{Noa MANIACI}{Entrée en Seconde générale et technologique}{Mathématiques --- à traiter individuellement}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A5.}] Résoudre $(4x - 12)(x + 6) = 0$.
\worklines{2}
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A6.}] Simplifier $10^{-4}\times 10^{7}$ et donner le résultat sous la forme d'une puissance de $10$.
\worklines{2}
\par\vspace{1.2mm}
\end{enumerate}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{B4.}] Un prix de $150$ TND augmente de $20\,\%$, puis le nouveau prix baisse de $25\,\%$.
\begin{enumerate}
\item Calculer le prix après chaque étape.
