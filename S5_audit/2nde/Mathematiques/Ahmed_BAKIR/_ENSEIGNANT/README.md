# Dossier enseignant — Ahmed BAKIR (Entrée en Seconde générale et technologique, Mathématiques)
...
2. Lancer :
   ...
   ```
   python3 S5_cloture/tools/analyze_s5.py --student ahmed-bakir --responses <fichier>
   ```
