# Dossier enseignant — Ahmad BELDI (Entrée en Première — Numérique et sciences informatiques, NSI)
...
2. Lancer :
   ...
   ```
   python3 S5_cloture/tools/analyze_s5.py --student ahmad-beldi-nsi --responses <fichier>
   ```
