...
\usepackage{nexusS5}
\setnexusheader{Entrée en Troisième — Stage de pré-rentrée}{Séance 5/5 — Fares LAAJILI}
\begin{document}
\nexuscover{SÉANCE 5 --- RÉINVESTIR, CONSOLIDER, PRÉPARER LA RENTRÉE}{Livret de travail}{Fares LAAJILI}{Consolidation fractions et trigonométrie}{Entrée en Troisième --- Mathématiques --- 1\,h\,15 de travail, puis 45 minutes d'évaluation dans un document séparé}
\begin{goalbox}
\textbf{Objectif personnel de cette séance.} Stabiliser le produit et le quotient de fractions, puis choisir le rapport trigonométrique à partir du nom des côtés et non d'une habitude.
\par\medskip
