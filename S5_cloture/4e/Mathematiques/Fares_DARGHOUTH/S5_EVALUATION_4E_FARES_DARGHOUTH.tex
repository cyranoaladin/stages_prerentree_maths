...
\usepackage{nexusS5}
\setnexusheader{Entrée en Quatrième — Stage de pré-rentrée}{Évaluation finale — Fares DARGHOUTH}
\begin{document}
\nexuscover{ÉVALUATION FINALE --- DIAGNOSTIC DE SORTIE}{Durée : 45 minutes}{Fares DARGHOUTH}{Entrée en Quatrième}{Mathématiques --- à traiter individuellement}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A5.}] Un triangle a une base de $16$ cm et une hauteur de $5$ cm. Calculer son aire, unité comprise.
\worklines{2}
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A6.}] Compléter $\dfrac{3}{5}=\dfrac{\ldots}{25}$, puis calculer $\dfrac{3}{5}-\dfrac{4}{25}$.
\worklines{2}
\par\vspace{1.2mm}
\end{enumerate}
