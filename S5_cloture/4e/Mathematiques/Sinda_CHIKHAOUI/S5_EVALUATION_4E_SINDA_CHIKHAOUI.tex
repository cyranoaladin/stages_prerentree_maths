...
\usepackage{nexusS5}
\setnexusheader{Entrée en Quatrième — Stage de pré-rentrée}{Évaluation finale — Sinda CHIKHAOUI}
\begin{document}
\nexuscover{ÉVALUATION FINALE --- DIAGNOSTIC DE SORTIE}{Durée : 45 minutes}{Sinda CHIKHAOUI}{Entrée en Quatrième}{Mathématiques --- à traiter individuellement}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A5.}] Calculer $7 - (-6) - 4$.
\worklines{2}
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{A6.}] Calculer $\dfrac{3}{4} - \dfrac{5}{12}$.
\worklines{2}
\par\vspace{1.2mm}
\end{enumerate}
...
\par\vspace{1.2mm}
\needspace{22mm}
\item[\textbf{C2.}] Un triangle a une aire de $54\ \text{cm}^2$ et une hauteur relative de $9$ cm.
\begin{enumerate}
